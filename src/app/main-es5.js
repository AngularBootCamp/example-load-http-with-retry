...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _employeeDetail__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./employeeDetail */
    "./src/app/employeeDetail.ts");
    /* harmony import */


    var _employeeDisplay__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./employeeDisplay */
    "./src/app/employeeDisplay.ts");
    /* harmony import */


    var _employeeList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./employeeList */
    "./src/app/employeeList.ts");
    /* harmony import */


    var _page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./page */
    "./src/app/page.ts");
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
      declarations: [_page__WEBPACK_IMPORTED_MODULE_6__["PageComponent"], _employeeList__WEBPACK_IMPORTED_MODULE_5__["EmployeeListComponent"], _employeeDetail__WEBPACK_IMPORTED_MODULE_3__["EmployeeDetailComponent"], _employeeDisplay__WEBPACK_IMPORTED_MODULE_4__["EmployeeDisplayComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"]]
    });
    /*@__PURE__*/
  ...
  /***/
  function srcAppEmployeeDetailTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _employeeDisplay__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./employeeDisplay */
    "./src/app/employeeDisplay.ts");
    ...
    EmployeeDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      directives: [_employeeDisplay__WEBPACK_IMPORTED_MODULE_1__["EmployeeDisplayComponent"]],
      encapsulation: 2
    });
    /*@__PURE__*/
  ...
  /***/
  function srcAppEmployeeDisplayTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function EmployeeDisplayComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
    ...
    EmployeeDisplayComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "card", 4, "ngIf"], [1, "card"], [1, "card-content"], [1, "card-title"]],
  ...
  /***/
  function srcAppEmployeeListTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function EmployeeListComponent_p_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EmployeeListComponent_p_4_Template_a_click_1_listener($event) {
          ...
          return ctx_r3.selectedEmployee.emit(employee_r2.id);
        });
    ...
    var EmployeeListComponent = function EmployeeListComponent() {
    ...
    EmployeeListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 5,
      vars: 1,
      consts: [[1, "card"], [1, "card-content"], [1, "card-title"], [4, "ngFor", "ngForOf"], [3, "click"]],
  ...
  /***/
  function srcAppEmployeeLoaderTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppLoaderFaultyTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "faulty", function () {
      return faulty;
    });
    /* harmony import */
    ...
    var rxjs_operators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! rxjs/operators */
    "./node_modules/rxjs/_esm2015/operators/index.js"); // This observable transformation can be used to simulate a faulty
    ...
    function faulty(opts) {
      ...
      return function (source) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["defer"])(function () {
          return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["timer"])(Math.random() * options.maxDelayMs).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["mergeMap"])(function (_value) {
            return Math.random() < options.errorProbability ? Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["throwError"])(new Error('Failed in faulty')) : source;
          }));
        });
      };
    }
  ...
  /***/
  function srcAppLoaderLoadWithRetryTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "LoadResultStatus", function () {
      return LoadResultStatus;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "statusStrings", function () {
      return statusStrings;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "loadWithRetry", function () {
    ...
    var statusStrings = ['In Progress', 'Retrying', 'Waiting to Retry', 'Success', 'Error'];
    var defaultOptions = {
      attempts: 3,
      retryDelayMs: 2000,
    ...
    function loadWithRetry(source, producer, opts) {
      var options = Object.assign(Object.assign({}, defaultOptions), opts);
      return source.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["switchMap"])(function (key) {
        var notifications = new rxjs__WEBPACK_IMPORTED_MODULE_0__["BehaviorSubject"]({
          status: LoadResultStatus.InProgress
        });
        var attempt = 0;
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["merge"])(notifications, Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["defer"])(function () {
          attempt++;
          return producer(key);
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["retryWhen"])(function (errors) {
          return errors.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (error) {
            return notifications.next({
              status: LoadResultStatus.Error,
              error: error,
              willRetry: attempt < options.attempts
            });
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(function (_) {
            return attempt < options.attempts;
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (_) {
            return notifications.next({
              status: LoadResultStatus.Waiting
            });
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["delayWhen"])(function () {
            return retryDelay(options, attempt);
          }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["tap"])(function (_) {
            return notifications.next({
    ...
    function retryDelay(options, attempt) {
      var jitter = (Math.random() - 0.5) * options.retryDelayMs * 0.5;
      var delay = options.retryDelayMs * Math.pow(options.retryBackoffCoefficient, attempt - 1) + jitter;
  ...
  /***/
  function srcAppPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _loader_faulty__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./loader/faulty */
    "./src/app/loader/faulty.ts");
    /* harmony import */


    var _loader_loadWithRetry__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./loader/loadWithRetry */
    "./src/app/loader/loadWithRetry.ts");
    /* harmony import */


    var _employeeLoader__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./employeeLoader */
    "./src/app/employeeLoader.ts");
    /* harmony import */


    var _employeeList__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./employeeList */
    "./src/app/employeeList.ts");
    /* harmony import */


    var _employeeDisplay__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./employeeDisplay */
    "./src/app/employeeDisplay.ts");
    /* harmony import */
    ...
    var PageComponent = function PageComponent(employeeLoader) {
      _classCallCheck(this, PageComponent);

      this.selectedEmployeeId = new rxjs__WEBPACK_IMPORTED_MODULE_1__["Subject"]();
      this.employees = employeeLoader.getList();
      var loadResults = Object(_loader_loadWithRetry__WEBPACK_IMPORTED_MODULE_4__["loadWithRetry"])(this.selectedEmployeeId, function (id) {
        return employeeLoader.getDetails(id).pipe(Object(_loader_faulty__WEBPACK_IMPORTED_MODULE_3__["faulty"])());
      } // add this to simulate bad connection
      ).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["share"])());
      this.status = loadResults.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (result) {
        return console.log('RECEIVED', result, 'at', new Date());
      }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
        return _loader_loadWithRetry__WEBPACK_IMPORTED_MODULE_4__["statusStrings"][result.status];
      }));
      this.showEmployeeDetails = loadResults.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
        return result.status === _loader_loadWithRetry__WEBPACK_IMPORTED_MODULE_4__["LoadResultStatus"].Success;
      }));
      this.selectedEmployee = loadResults.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["filter"])(function (result) {
        return result.status === _loader_loadWithRetry__WEBPACK_IMPORTED_MODULE_4__["LoadResultStatus"].Success;
      }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (result) {
        return result.data;
      }));
    ...
    PageComponent.ɵfac = function PageComponent_Factory(t) {
      return new (t || PageComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_employeeLoader__WEBPACK_IMPORTED_MODULE_5__["EmployeeLoader"]));
    };
    ...
    PageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 12,
      consts: [[1, "two-across"], [3, "employees", "selectedEmployee"], [1, "status"], [3, "employee"]],
      template: function PageComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("selectedEmployee", function PageComponent_Template_employee_list_selectedEmployee_1_listener($event) {
            return ctx.selectedEmployeeId.next($event);
          });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PageComponent, [{
      ...
      return [{
        type: _employeeLoader__WEBPACK_IMPORTED_MODULE_5__["EmployeeLoader"]
      }];
    }, null);
    /***/
